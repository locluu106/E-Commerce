                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-3"  >
                                                ...
                                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:set var="t" value="t"></c:set>
                                                        <c:forEach var="orderDetails" items="${orderList}">
                                                            <c:set var="s" value="${s + orderDetails.total}"></c:set>
                                                            <c:set var="t" value="${orderDetails.quantity * orderDetails.productDetails.priceFormatted}"></c:set>
                                                                <tr>
                                                                <td>${orderDetails.quantity}</td>
                                                                <td>$ ${orderDetails.productDetails.priceFormatted}</td>
                                                                <td>${orderDetails.productDetails.productDetailsName}</td>
                                                                <td>${orderDetails.productDetails.size.sizeName}</td>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-3"  >
                                                    <div class="list-group">
                                                        <a class="list-group-item  active">Total Order</a>

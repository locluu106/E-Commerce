                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">List Manufacture</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">List Manufacture</strong>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-md">
                                            <a href="${pageContext.request.contextPath}/addPro"><button id="addToTable" class="btn btn-primary">Add <i class="fa fa-plus"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <c:forEach var="product" items="${proList}">
                                                <tr class="gradeX">
                                                    ...
                                                    <td class="actions">
                                                        <a href="${pageContext.request.contextPath}/viewProduct/${product.productId}"><i>View Details</i></a>
                                                    </td>
                                                    <td class="actions">
                                                        <a href="${pageContext.request.contextPath}/editPro/${product.productId}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                                    </td>   
                                                    <td class="actions">
                                                        <a href="${pageContext.request.contextPath}/deletePro/${product.productId}" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>

                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <mvc:form modelAttribute="customer" action="${pageContext.request.contextPath}/updateCustomer" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Id</label>
                                            <div class="col-md-6">
                                                <mvc:input path="customerId" readonly="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                        ...
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputDisabled">Address</label>
                                            <div class="col-md-6">
                                                <mvc:input path="customerAddress" required="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Phone</label>
                                            <div class="col-md-6">
                                                <mvc:input path="customerPhone" required="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Email</label>
                                            <div class="col-md-6 ">                                                              
                                                 <mvc:input path="customerEmail"  type="email" required="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Birth Date</label>
                                            <div class="col-md-6">     
                                                 <mvc:input path="customerBirthDate" type="date" required="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Sex</label>
                                            <div class="col-md-6">
                                                <mvc:select path="sex" class="form-control" items="${sex1}"/>
                                            </div>
                                        </div>
                                        <div class="row form-group">

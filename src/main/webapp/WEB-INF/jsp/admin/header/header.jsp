        ...
        <ul class="navbar-nav align-items-center right-nav-link">
          <li class="nav-item">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li class="dropdown-item user-details">
                <a href="javaScript:void();">
                  <div class="media">
                	...
                	<b> Admin:  ${pageContext.request.userPrincipal.name}</b>                         
                    </div>
                  </div>
                </a>
              </li>
			 ...
			 <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="<c:url value = "/logout"/>"> Đăng xuất</a></li>		
            </ul>
          </li>
        </ul>
      </nav>

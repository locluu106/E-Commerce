            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header"><strong>Add Manufacture</strong></div>
                                <div class="card-body card-block">
                                    <mvc:form modelAttribute="product" action="${pageContext.request.contextPath}/addPro" class="form-horizontal form-bordered" method="post">

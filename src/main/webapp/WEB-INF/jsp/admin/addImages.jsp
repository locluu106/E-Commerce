                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="uploadFile" enctype="multipart/form-data" class="form-horizontal form-bordered" method="post">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="inputDefault">Image Name</label>
                                            <div class="col-md-6">
<!--                                                <input type="file" name="images" required="true" class="form-control" id="inputDefault" />-->

                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <mvc:form modelAttribute="productDetails" action="${pageContext.request.contextPath}/updateProductDetails" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Id</label>
                                            <div class="col-md-6">
                                                <mvc:input path="productDetailsId" readonly="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">

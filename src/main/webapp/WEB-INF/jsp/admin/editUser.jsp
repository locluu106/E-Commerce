                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <mvc:form modelAttribute="user" action="${pageContext.request.contextPath}/updateUser" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">

                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="${pageContext.request.contextPath}/listColor">List Color</a></li>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <mvc:form modelAttribute="color" action="${pageContext.request.contextPath}/addColor" class="form-horizontal form-bordered" method="post">
                                        <div class="row form-group">
                                            <label class="col-md-3 control-label" for="inputReadOnly">Name</label>
                                            <div class="col-md-6">
                                                <mvc:input path="colorName" required="true" class="form-control" id="inputDefault" />
                                            </div>
                                        </div>
                                        <div class="row form-group">

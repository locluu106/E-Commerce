                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="#"><i class="fa fa-map-marker"></i>Đà Nẵng,Viêt Nam</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>0236 777 8888</a></li>
                            <li><a href="#"><i class="fa fa-envelope-o"></i>binmobile@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
